...
<br><br>
    ...
    <section class="contactSec">
       ...
       <table class="contactForm" >
            <tr><th class="formTitle" colspan="2">  We're Happy To Help You ! </th></tr>
            <tr>
                <td class="col1" rowspan="2">
					...
					<input id="inputCont" type="text" name="subject" id="subject" size="40" placeholder="Subject" class="input-form"><br><br>
                    <textarea id="inputCont" type="text" row="3" cols="40" name="message" id="message"  placeholder="Message" class="textarea"></textarea><br><br>
                    <input type="file" name="fileToUpload" id="fileToUpload" size="40" class="input-form"><br><br>
                    <button type="submit" value="contact" class="btn1">Submit</button>
                </td>
                <td rowspan="2" >
                    <div class="image">
    ...
    <script>
        function registration(conForm){
            ...
            fail += subject(conForm.subject.value);
            if ( fail == "") return true
            else {
                alert(fail); 
                return false
